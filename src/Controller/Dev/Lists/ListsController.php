...
class ListsController extends MainController
{
    ...
    public function addItem($datas): void
    {
        ...
        $isExisting = $this->listsModel->ItemExists($id_list, $content, $created_by);

        if ($this->listsModel->createNewItem($id_list, $content, $created_by)) {
            if ($isExisting) {
    ...
    public function itemIsDone($datas): void
    {
        ...
        $this->listsModel->updateItemDoneStatus($item_id, $is_done);
    ...
    public function deleteItem($datas): void
    {
        ...
        if ($this->listsModel->deleteItem($item_id)) {
    ...
    public function deleteAllDone($datas): void
    {
        ...
        if ($this->listsModel->deleteAllDoneItems($id_list)) {
...
public function updateItem($datas): void
    {
        ...
        if ($this->listsModel->updateItemContent($item_id, $new_content)) {
